...
function ensureInitialized() {
  ...
  if (props.getProperty('SCHEMA_V') === '13') {
    // File đã ở schema 13 → vẫn cần backfill 1 lần (idempotent qua cờ riêng).
