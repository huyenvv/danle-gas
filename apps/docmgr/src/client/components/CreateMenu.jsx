...
// Used in the sidebar CTA (compact=false, supports collapsed) and the documents
// list toolbar (compact=true). The caret only appears when onImport is provided.
export default function CreateMenu({ onCreate, onImport, label = 'Tạo hồ sơ mới', compact = false, collapsed = false }) {
  ...
  if (!onCreate && !onImport) return null
